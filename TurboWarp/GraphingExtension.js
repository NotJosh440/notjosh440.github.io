...
class GraphingExtension {
    ...
    ComplexPow(args){
        const result = new Complex(args.RONE, args.IONE).pow(args.RTWO, args.ITWO);
        const formattedResult = `${result.re} + ${result.im}i`;
        return formattedResult;
    }

    ComplexAdd(args){
        const result = new Complex(args.RONE, args.IONE).add(args.RTWO, args.ITWO);
        const formattedResult = `${result.re} + ${result.im}i`;
        return formattedResult;
    }
